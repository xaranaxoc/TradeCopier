...
%PYTHON% -m pip install pyinstaller MetaTrader5 psutil customtkinter
if %errorlevel% neq 0 (
...
echo [3/3] Готово!
echo ============================================
echo   Файл: dist\TradeCopier.exe
